% 设置文件夹路径
folderPath = 'D:\WorkBench\Master\bin\x64\Debug\AnnotatedData'; % 修改为你的文件夹路径
...
for k = 1:length(csvFiles)
    ...
    % 添加偏移后绘制信号
    plot(t, data + offset, 'LineWidth', 1.5, 'DisplayName', csvFiles(k).name);
